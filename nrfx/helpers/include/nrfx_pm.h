...
typedef enum {
    NRFX_PM_EVENT_SHUTDOWN, ///< Event generated when the instance of the peripheral has been turn off.
    NRFX_PM_EVENT_RESTORED, ///< Event generated when the instance of the peripheral has been turn on.
} nrfx_pm_event_t;
